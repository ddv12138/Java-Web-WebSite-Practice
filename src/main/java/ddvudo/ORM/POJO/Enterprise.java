...
public class Enterprise implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
                ...
                && (this.getCharacter() == null ? other.getCharacter() == null : this.getCharacter()
                .equals(other.getCharacter()))
                && (this.getLegalrepresentative() == null ? other.getLegalrepresentative() == null : this
                .getLegalrepresentative().equals(other.getLegalrepresentative()))
                && (this.getCapital() == null ? other.getCapital() == null : this.getCapital()
                .equals(other.getCapital()))
                && (this.getBusinessscope() == null ? other.getBusinessscope() == null : this.getBusinessscope()
                .equals(other.getBusinessscope()))
                && (this.getProvince() == null ? other.getProvince() == null : this.getProvince()
                .equals(other.getProvince()))
                && (this.getCity() == null ? other.getCity() == null : this.getCity().equals(other.getCity()))
                && (this.getAddress() == null ? other.getAddress() == null : this.getAddress()
